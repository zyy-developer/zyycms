...
import com.zyy.common.core.domain.entity.SysDept;
...
public class SysRoleController extends BaseController
{
    ...
    @Autowired
    private ISysRoleCmsService roleCmsService;
    ...
    public AjaxResult add(@Validated @RequestBody SysRole role)
    {
        ...
        if(role.getSiteIds()!=null){
            roleCmsService.insertCmsRole(role);
        }
        if(role.getChannelIds()!=null){
            /// roleCmsService.insertCmsRoleByChannel(role);
        }
        return toAjax(rows);
     ...
     */
//    @PreAuthorize("@ss.hasPermi('system:role:edit')")
    @Log(title = "角色栏目管理", businessType = BusinessType.UPDATE)
    @PutMapping("/roleChannels")
    public AjaxResult updateRoleChannels(@RequestBody SysRole role)
    {
        return toAjax(roleCmsService.insertCmsRoleByChannel(role));
    }
