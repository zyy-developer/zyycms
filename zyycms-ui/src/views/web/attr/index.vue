...
<script>
import { listAttr, getAttr, delAttr, addAttr, updateAttr } from "@/api/web/attr";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除自定义属性编号为"' + ids + '"的数据项？').then(function() {
        return delAttr(ids);
      }).then(() => {
        this.getList();
