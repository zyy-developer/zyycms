...
public class SysMenuController extends BaseController
{
    ...
    public AjaxResult roleMenuTreeselect(@PathVariable("roleId") Long roleId)
    {
        ...
        List<CmsSite> sites = cmsSiteService.selectCmsSiteList(new CmsSite());
        AjaxResult ajax = AjaxResult.success();
        ajax.put("checkedKeys", menuService.selectMenuListByRoleId(roleId));
        SysRoleCms sysRoleCms = new SysRoleCms();
        sysRoleCms.setRoleId(roleId);
        sysRoleCms.setPropertyType("site");
        ajax.put("checkedKeysBySites", cmsService.selectSysRoleCmsList(sysRoleCms));
        ajax.put("menus", menuService.buildMenuTreeSelect(menus));
        ajax.put("sites",cmsSiteService.buildDeptTreeSelect(sites));
        return ajax;
    }
